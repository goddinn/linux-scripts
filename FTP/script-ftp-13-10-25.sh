...
read -rp "Indique o nome do utilizador FTP a criar (ex: ftpuser): " FTP_USER
...
if command -v getenforce >/dev/null 2>&1 && [[ "$(getenforce)" == "Enforcing" ]]; then
  echo "[INFO] SELinux em Enforcing: a ajustar boolean ftpd_full_access..."
